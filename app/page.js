  ...
  return (
    <main className="flex flex-row justify-center items-center min-h-screen gap-20 font-uber">
      <div className="flex flex-col text-left mb-20">
        ...
        <Image src={'/apple.svg'} width={220} height={200} alt="app store download"></Image>
      </div>
      <Image className="rounded-3xl mb-20" src={'/logo.png'} width={200} height={200} alt="app logo"></Image>
    </main>
  )
}
